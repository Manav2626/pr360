...
<main class="vlt-main">
		...
		<div class="vlt-page-content">
			<!--Page title-->
			<div class="vlt-page-title vlt-page-title--style-3 jarallax"><img class="jarallax-img" src="assets/img1/about_hero.jpg" alt="" loading="lazy">
				...
				<div class="container">
					<h1 class="vlt-page-title__title lax" data-lax-translate-y="0 0, vh (vw*0.25)" data-lax-opacity="1 1, (vh*0.5) 0" data-lax-anchor=".vlt-page-title">About Us
					</h1>
				</div>
			</div>
			<div id="content"></div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-11 offset-md-1">
							<!--Animated block-->
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="0"><span class="vlt-display-1 has-primary-color">Who Are We</span>
							</div>
						...
						<div class="col-md-12 offset-md-1">
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="0">
								...
								<div class="vlt-service vlt-service--style-1">
									...
									<div class="vlt-service__content">
										<h5 class="vlt-service__title" style=" color:#ffffff;"><a href="service-single.html">Uniformity</a>
										</h5>
										<p class="vlt-service__text" style=" color:#B3B3B3;">Ensuring content uniformity for a premium brand experience.
										</p>
									</div>
								</div>
							</div>
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="200">
								...
								<div class="vlt-service vlt-service--style-1">
									...
									<div class="vlt-service__content">
										<h5 class="vlt-service__title" style=" color:#ffffff;"><a href="service-single.html">Quality</a>
										</h5>
										<p class="vlt-service__text" style=" color:#B3B3B3;">Delivering excellence and quality in every service we provide.
										</p>
									</div>
								</div>
							</div>
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="0">
								...
								<div class="vlt-service vlt-service--style-1">
									...
									<div class="vlt-service__content">
										<h5 class="vlt-service__title" style=" color:#ffffff;"><a href="service-single.html">Outcome</a>
										</h5>
										<p class="vlt-service__text" style=" color:#B3B3B3;">Striving for the best outcomes in every project we undertake.
										</p>
									</div>
								</div>
							</div>
						...
						<div class="col-auto">
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="0">
								...
								<div class="vlt-counter-up vlt-counter-up--style-3" data-animation-speed="1000" data-delimiter="">
									...
									<div class="vlt-counter-up__counter">5</div><span>+</span>
									<h5 class="vlt-counter-up__title">Years of Digital<br> Marketing Experience
									</h5>
								</div>
							</div>
						</div>
			...
			<section class="position-relative has-black-color">
				...
				<div class="container">
					<div class="text-center">
						...
						<div class="vlt-animated-block" data-aos="fade" data-aos-delay="0">
							<!--Stroke text-->
							<div class="vlt-stroke-text vlt-stroke-text--lg"><a href="./contact.php" target="_self">Let's work</a>
							</div>
						</div>
					</div>
				</div>
