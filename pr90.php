					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="100">
								<p class="fz-3">The PR90 package delivers a robust blend of digital and on-ground marketing strategies, featuring expert social media management, SEO optimization, and targeted community outreach. </p>
							</div>
			...
			<section class="vlt-page-navigation vlt-page-navigation--style-1 has-black-color">
				...
				<div class="container">
					<div class="text-center">
						<!--Stroke text-->
						<div class="vlt-stroke-text vlt-stroke-text--lg"><a href="pr90+.php" target="_self">Next service</a>
						</div>
					</div>
				</div>
				<div class="vlt-gap-130"></div>
