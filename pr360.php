<?php include 'head.php'; ?>
	...
	<main class="vlt-main">
		...
		<div class="vlt-page-content">
			<!--Page title-->
			<div class="vlt-page-title vlt-page-title--style-2 jarallax"><img class="jarallax-img" src="assets/img1/pr360.svg" alt="" loading="lazy">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-11 offset-md-1">
							<!--Animated block-->
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="0"><span class="vlt-display-1 has-primary-color">For Hospitals</span>
							</div>
						...
						<div class="col-md-5 offset-md-1">
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="0">
								<h2>Enhance your <br>Hospital's Impact</h2>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="100">
								<p class="fz-3">The pr360 package offers a comprehensive solution for hospitals, integrating both digital and on-ground marketing. It includes dedicated social media management, with 3 allocated PROs and targeted community outreach. Additionally, the package features third-party assurance tie-ups to further enhance your hospital’s credibility and engagement in the community.</p>
							</div>
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="300">
								<div class="has-black-color">
                                    ...
                                    <li>Social Media
                                        ...
                                        <li>Feature in PR360's Podcast</li>
                                        <li>3 Alloted PRO's</li>
                                        <li>Referral Business</li>
                                        <li>CME / Community Outreach</li>
										<li>Thirdparty Assurance Tieups</li>
									</ul>
								</div>
							</div>
						</div>
			...
			<section class="vlt-page-navigation vlt-page-navigation--style-1 has-black-color">
				...
				<div class="container">
					<div class="text-center">
						<!--Stroke text-->
						<div class="vlt-stroke-text vlt-stroke-text--lg"><a href="pr270.php" target="_self">Previous service</a>
						</div>
					</div>
				</div>
				<div class="vlt-gap-130"></div>
