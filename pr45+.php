<?php include 'head.php'; ?>
	...
	<main class="vlt-main">
		...
		<div class="vlt-page-content">
			<!--Page title-->
			<div class="vlt-page-title vlt-page-title--style-2 jarallax"><img class="jarallax-img" src="assets/img1/pr45+.svg" alt="" loading="lazy">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="100">
								<p class="fz-3">The PR45+ package offers a comprehensive solution for managing your social media, and driving consistent growth across all social media platforms. Ideal for individuals aiming for enhanced visibility and engagement.</p>
							</div>
