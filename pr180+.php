<?php include 'head.php'; ?>
	...
	<main class="vlt-main">
		...
		<div class="vlt-page-content">
			<!--Page title-->
			<div class="vlt-page-title vlt-page-title--style-2 jarallax"><img class="jarallax-img" src="assets/img1/pr180+.svg" alt="" loading="lazy">
					...
					<div class="row">
						...
						<div class="col-md-5 offset-md-1">
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="0">
								<h2>Boost your <br> Social Media Presence</h2>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="100">
								<p class="fz-3">The PR180+ package offers a specialized social media solution tailored for hospitals, focusing on enhancing your online presence through strategic content creation, targeted engagement, and performance tracking. This package is designed to boost your hospital’s visibility, connect with patients, and effectively communicate health-related information across all social media platforms.</p>
							</div>
			...
			<section class="vlt-page-navigation vlt-page-navigation--style-1 has-black-color">
				...
				<div class="container">
					<div class="text-center">
						<!--Stroke text-->
						<div class="vlt-stroke-text vlt-stroke-text--lg"><a href="pr270.php" target="_self">Next service</a>
						</div>
					</div>
				</div>
				<div class="vlt-gap-130"></div>
