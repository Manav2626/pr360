<?php include 'head.php'; ?>
	...
	<main class="vlt-main">
		...
		<div class="vlt-page-content">
			<!--Page title-->
			<div class="vlt-page-title vlt-page-title--style-2 jarallax"><img class="jarallax-img" src="assets/img1/pr90+.svg" alt="" loading="lazy">
					...
					<div class="row">
						...
						<div class="col-md-5 offset-md-1">
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="0">
								<h2>Elevate Your <br>Business Goals </h2>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="100">
								<p class="fz-3">The PR90+ package delivers a robust blend of digital and on-ground marketing strategies, featuring expert social media management, SEO optimization, and targeted community outreach. With an allotted PRO to handle personalized interactions and outreach, this package is designed for businesses aiming for comprehensive growth and increased local engagement.</p>
							</div>
			...
			<section class="vlt-page-navigation vlt-page-navigation--style-1 has-black-color">
				...
				<div class="container">
					<div class="text-center">
						<!--Stroke text-->
						<div class="vlt-stroke-text vlt-stroke-text--lg"><a href="pr180.php" target="_self">Next service</a>
						</div>
					</div>
				</div>
				<div class="vlt-gap-130"></div>
