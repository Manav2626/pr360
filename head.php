...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-JG35ZT8WX6"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-JG35ZT8WX6');
</script>
					...
					<div class="vlt-navbar-inner">
						<div class="vlt-navbar-inner--left">
							<div class="d-flex align-items-center justify-content-center h-100">
								<!--Logo--><a class="vlt-navbar-logo" href="index.php"><img class="black" src="assets/img/root/pr360.png" alt="" style="height: 85px;" loading="lazy"><img class="white" src="assets/img/root/pr360.png" alt="" style="height: 85px;" loading="lazy"></a>
							</div>
						</div>
