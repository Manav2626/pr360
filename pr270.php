<?php include 'head.php'; ?>
	...
	<main class="vlt-main">
		...
		<div class="vlt-page-content">
			<!--Page title-->
			<div class="vlt-page-title vlt-page-title--style-2 jarallax"><img class="jarallax-img" src="assets/img1/pr270.svg" alt="" loading="lazy">
					...
					<div class="row">
						...
						<div class="col-md-5 offset-md-1">
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="0">
								<h2>Transform your <br>Marketing Strategy </h2>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="vlt-animated-block" data-aos="fade" data-aos-delay="100">
								<p class="fz-3">The PR270 package offers an integrated approach to social media and on-ground marketing for hospitals, combining effective digital strategies with hands-on community outreach. Featuring 2 allotted PROs for personalized engagement and targeted local initiatives, this package is designed to enhance your hospital’s online visibility while fostering meaningful connections in your community.</p>
							</div>
			...
			<section class="vlt-page-navigation vlt-page-navigation--style-1 has-black-color">
				...
				<div class="container">
					<div class="text-center">
						<!--Stroke text-->
						<div class="vlt-stroke-text vlt-stroke-text--lg"><a href="pr360.php" target="_self">Next service</a>
						</div>
					</div>
				</div>
				<div class="vlt-gap-130"></div>
