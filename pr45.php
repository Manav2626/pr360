				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="vlt-animated-block" data-aos="fade" data-aos-delay="100">
							<p class="fz-3">The PR45 package offers a comprehensive solution for managing your social media, optimizing SEO, and driving consistent growth across all platforms. Ideal for individuals aiming for enhanced visibility and engagement.</p>
						</div>
		...
		<section class="vlt-page-navigation vlt-page-navigation--style-1 has-black-color">
			...
			<div class="container">
				<div class="text-center">
					<!--Stroke text-->
					<div class="vlt-stroke-text vlt-stroke-text--lg"><a href="pr45+.php" target="_self">Next service</a>
					</div>
				</div>
			</div>
			<div class="vlt-gap-130"></div>
